...
public class Main {
    ...
    private final static Missao missao = new Missao();
    ...
    public static void Menu(){
        ...
        switch(opcao){
            case 1: gerenciarAgentes();
                break;
            case 2: gerenciarMissoes();
                break;
            case 3: participacaoEmMissoes();
                break;
            case 4: consultasRelatorios();
                break;
            case 5:
    ...
    private static void participacaoEmMissoes() {
        ...
        int opcao = sc.nextInt();
        switch(opcao){
            case 1: adicionarAgenteMissao();
                break;
            case 2: removerAgenteMissao();
                break;
            case 3: iniciarMissaoMain();
                break;
            case 4:
    ...
    private static void gerenciarMissoes() {
        ...
        switch(opcao){
            case 1: criarMissao();
                break;
            case 2: atualizarMissao();
                break;
            case 3: excluirMissao();
                break;
            case 4:
                System.out.println("Voltando ao Menu Principal");
                break;
    ...
    private static void gerenciarAgentes() {
        ...
        switch(opcao){
            case 1: criarAgente();
                break;
            case 2: atualizarAgente();
                break;
            case 3: removerAgente();
                break;
            case 4:
                System.out.println("Voltando ao Menu Principal");
                break;
    ...
    private static void atualizarAgente() {
        ...
        if(ger.buscarAgente(nome) == null){
            ...
            ger.atualizarAgenteGer(nivel, vida);
        }
